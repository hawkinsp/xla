...
// Implements the nccl API by forwarding to nccl loaded from the DSO.
...
void* GetDsoHandle() {
  ...
  static auto handle = []() -> void* {
    auto handle_or =
        tsl::internal::DsoLoader::GetNcclDsoHandle();
...
static ncclResult_t GetSymbolNotFoundError() {
  return ncclSystemError;
}

static const char* ReturnErrorString() {
  return "Error loading NCCL.";
}
